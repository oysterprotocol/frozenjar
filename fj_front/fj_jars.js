var w = c.width = document.getElementById('chinchilla').offsetWidth,
	h = c.height = document.getElementById('chinchilla').offsetHeight,
	ctx = c.getContext('2d'),
...
window.addEventListener( 'resize', function(){
	...
	w = c.width = document.getElementById('chinchilla').offsetWidth;
	h = c.height = document.getElementById('chinchilla').offsetHeight;
	ctx.fillStyle = 'rgb(52,128,173)';
	ctx.fillRect( 0, 0, w, h );
